<div class="bg-white rounded-lg mt-[6em] mb-[2em] shadow-md p-6 max-w-2xl mx-auto">
    ...
    <h2 class="text-2xl font-bold text-purple-800 mb-6 text-center">Gestión de Perfil</h2>
    ...
    <form wire:submit.prevent="updateProfile" class="space-y-6">
        ...
        <div class="pt-4 border-t border-gray-200">
            <h3 class="text-lg font-medium text-purple-700 mb-3">Cambiar Contraseña</h3>
